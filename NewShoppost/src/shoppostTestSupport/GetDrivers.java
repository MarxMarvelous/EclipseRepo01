...
public class GetDrivers {
	...
	public WebDriver set() throws Exception {
		...
		case "*internetexplorer":
			...
			System.setProperty("webdriver.ie.driver", "C:\\Projects\\IEDriverServer_Win32_2.41.0\\iedriverserver.exe");
			driver = new InternetExplorerDriver();
			//driver.manage().window().maximize();
			break;
			
		case "*chrome":
			System.setProperty("webdriver.chrome.driver", "C:\\Users\\DIY\\Dropbox\\MarkFolder\\TestingEclipseJava\\TestPhysical\\EclipseWork\\chromedriver_win32_2.9\\chromedriver.exe");
